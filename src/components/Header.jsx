...
function Header() {
    ...
    return (
        <>
            <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 pt-4 shadow-md h-20 sticky fixed top-0 right-0 left-0 relative bg-blue-600 text-white">
                <div className='flex justify-between items-center'>
                    <a href="/"> <div className='flex justify-between space-x-2 cursor-pointer'>
                        <img className='h-12 w-12' src={logo} alt="Logo" />
                        <div className='flex justify-between'>
                            <h1 className='font-bold'>Am<span className='font-bold text-lg text-red-600'>i</span>t
                ...
                {/* mobile navbar */}
                <div className='bg-blue-600 w-32 absolute top-20 right-0 '>
